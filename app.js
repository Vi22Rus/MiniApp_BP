// Version: 1.6.0 | Lines: 911
// Last updated: 2025-09-30
// Версия скрипта: app.js (911 строк) - Клик по блоку вместо кнопок
...
function handleCardClick(activityName, date, type) {
    if (type === 'sea') {
        // Открываем ежедневник для блоков Пляжинг/В Паттайю
        openDailyPlanModal(activityName, date);
    } else if (type === 'sight') {
        // Открываем попап с подробной информацией для активностей
