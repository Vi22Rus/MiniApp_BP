// Version: 1.3.2 | Lines: 680
// Last updated: 2025-09-30
// Версия скрипта: app.js (680 строк) - С ОБНОВЛЕННЫМ КАЛЕНДАРЕМ
...
const allGeoData = [
    ...
    { type: 'playground', link: "https://maps.app.goo.gl/RztRChbuiEd5QLeh8", coords: [12.9493868, 100.8905801], name: "HarborLand Terminal 21", tips: "..." },
    { type: 'playground', link: "https://maps.app.goo.gl/f1SWXADzM47CXUMh8", coords: [12.9349781, 100.8827918], name: "Kidzoona Central Festival", tips: "..." },
    { type: 'playground', link: "https://maps.app.goo.gl/AUvvP5cSzAK9bXDH6", coords: [12.9339314, 100.8975418], name: "Harbor Pattaya Mega Fun", tips: "..." },
    { type: 'playground', link: "https://maps.app.goo.gl/RFym8tDpDSzGZjiq6", coords: [12.9845896, 100.9498388], name: "Pattaya Dinosaur Kingdom", tips: "..." },
    { type: 'playground', link: "https://maps.app.goo.gl/y9gx662uNMzav5HJA", coords: [12.9531928, 100.9384322], name: "Pipo Pony Club", tips: "..." },
    { type: 'playground', link: "https://maps.app.goo.gl/yt7ifzd85dPxYjkQ7", coords: [12.7500807, 100.9618892], name: "Ramayana Kids Zone", tips: "..." },
    { type: 'playground', link: "https://maps.app.goo.gl/JnJU2g9p91rk2rf48", coords: [12.9350308, 100.8827184], name: "MO Play Kidz", tips: "..." },
    // Парки (32-39) 
    { type: 'park', link: "https://maps.app.goo.gl/wz7LAkoqXd1LHHhw7", coords: [12.914219, 100.868615], name: "Chaloem Phrakiat Park", tips: "..." },
    { type: 'park', link: "https://maps.app.goo.gl/VzHiKzb1UDQwrJ7SA", coords: [12.932456, 100.881234], name: "Pattaya Park Beach Resort", tips: "..." },
    { type: 'park', link: "https://maps.app.goo.gl/1Tho69ErwjcJoLZu6", coords: [12.927890, 100.877123], name: "Beach Road Promenade", tips: "..." },
    { type: 'park', link: "https://maps.app.goo.gl/ZaWV44GNL86E9Hdq9", coords: [12.892345, 100.873567], name: "Jomtien Beach Park", tips: "..." },
    { type: 'park', link: "https://maps.app.goo.gl/wz7LAkoqXd1LHHhw7", coords: [12.914567, 100.868234], name: "Buddha Hill Park", tips: "..." },
    { type: 'park', link: "https://maps.app.goo.gl/QfwfiipfFmXzfJhCA", coords: [12.913456, 100.867890], name: "Wat Khao Phra Bat Garden", tips: "..." },
...
// ОБНОВЛЕННЫЙ массив kidsLeisure с новыми активностями
const kidsLeisure = [
    { name: 'Mini Siam', date: '01.01.2026', coords: { lat: 12.9554157, lng: 100.9088538 }, tips: 'Парк миниатюр мирового уровня... (полное описание)', type: 'sight' },
    { name: 'Деревня слонов', date: '04.01.2026', coords: { lat: 12.91604299, lng: 100.93883441 }, tips: 'Этический слоновый заповедник... (полное описание)', type: 'sight' },
    { name: 'Дельфинариум', date: '07.01.2026', coords: { lat: 12.95222191, lng: 100.93617557 }, tips: 'Современный дельфинариум... (полное описание)', type: 'sight' },
    { name: 'Аюттайя на сутки', date: '08.01.2026', type: 'sight', coords: { lat: 14.35741905, lng: 100.56757512 }, tips: 'Древняя столица Сиама, объект всемирного наследия ЮНЕСКО. Руины храмов XIV-XVIII веков. Знаменитая голова Будды в корнях дерева в Wat Mahathat. Расстояние от Паттайи: 150 км (2.5 часа езды). Планируйте полный день с рано утра. Лучше брать экскурсию с гидом. Обязательно: Wat Chaiwatthanaram, Wat Phra Si Sanphet. Удобная обувь обязательна!' },
    { name: 'Возвращение в Паттайю', date: '09.01.2026', type: 'sea', coords: null, tips: 'Отдых и восстановление сил после поездки в Аюттайю.' },
    { name: 'Сад Нонг Нуч', date: '11.01.2026', coords: { lat: 12.76575858, lng: 100.93505629 }, tips: 'Всемирно известный тропический ботанический сад... (полное описание)', type: 'sight' },
    { name: 'Музей искусств 3D', date: '13.01.2026', coords: { lat: 12.94832322, lng: 100.88976288 }, tips: 'Интерактивный музей... (полное описание)', type: 'sight' },
    { name: 'Ко Лан', date: '14.01.2026', coords: { lat: 12.915123, lng: 100.780456 }, tips: 'Однодневная поездка на Коралловый остров... (полное описание)', type: 'sight' },
    { name: 'Возвращение в Паттайю', date: '15.01.2026', type: 'sea', coords: null, tips: 'Отдых и восстановление сил.' },
    { name: 'Зоопарк Кхао Кхео', date: '19.01.2026', coords: { lat: 13.21500644, lng: 101.05700099 }, tips: 'Крупнейший открытый зоопарк... (полное описание)', type: 'sight' },
    { name: 'Плавучий рынок', date: '22.01.2026', coords: { lat: 12.86799376, lng: 100.90469404 }, tips: 'Аутентичный плавучий рынок... (полное описание)', type: 'sight' },
...
function renderActivities(list) {
    ...
    grid.innerHTML = list.map(a => {
        ...
        const prices = {
            ...
            'Ко Лан': `<p class="price-tag"><span class="price-label">Паром</span> 30 ฿ / <span class="price-label">Общие расходы</span> ~1,500 ฿</p>`,
        };
        ...
        const buttonHtml = (a.type === 'sea' || a.name === 'Поездка на Ко Лан') ? 
...
// ОБНОВЛЕНО: Добавлены иконки для новых активностей
...
function initDailyPlanModal() {
    ...
    if (modal) {
        modal.addEventListener('click', e => {
            if (e.target.id === 'modalOverlay') closeDailyPlanModal();
        });
    }
}
