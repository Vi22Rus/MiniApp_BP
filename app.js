// Version: 1.3.0 | Lines: 650
// Last updated: 2025-09-29
// Версия скрипта: app.js (650 строк) - ПОЛНЫЙ ОБНОВЛЕННЫЙ КОД
...
const allGeoData = [
    ...
    // ОБНОВЛЕННЫЕ Детские игровые центры (25-31) - убираем Snow Land, добавляем MO Play Kidz
    { 
        type: 'playground', 
    ...
    { 
        type: 'playground', 
        link: "https://maps.app.goo.gl/MOPlayKidz", 
        coords: [12.935051, 100.882722],
        name: "MO Play Kidz",
...
// ОБНОВЛЕННЫЙ массив kidsLeisure с полными описаниями
const kidsLeisure = [
    { 
        name: 'Mini Siam', 
        date: '01.01.2026', 
...
// УБИРАЕМ MO Play Kidz из points (он теперь в детских площадках)
const points = [];
