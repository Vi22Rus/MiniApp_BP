...
function renderActivities(list) {
  ...
  'Шоу слонов': '<p class="price">Взрослый 650 ฿ / Детский 500 ฿</p>',
  'Шоу тигров': '<p class="price">Взрослый 630 ฿ / Детский 450 ฿</p>',
  'Аютайя': '<p class="price">Взрослый 420 ฿ / Детский 320 ฿</p>',
  'Нонг Нуч': '<p class="price">Взрослый 840 ฿ / Детский 420 ฿</p>',
  'Ко Лан': '<p class="price">Взрослый 30 ฿ / Детский 1,500 ฿</p>',
